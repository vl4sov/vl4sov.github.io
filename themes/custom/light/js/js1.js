...
(function ($) {
  ...
  $(".toggle-menu").click(function () {
    if ($(".navigation-mobile").hasClass('show')) {
      $(".navigation-mobile").css('left', '-200px');
      $(".navigation-mobile").toggleClass("show");
    } else {
      $(".navigation-mobile").css('left', '0');
      $(".navigation-mobile").toggleClass("show");
    }
  ...
  $('.lua-download-btn').click(function () {
    $(".lua-script--alert-terms").show();
  });
}(jQuery));
;
(function ($) {
  Drupal.behaviors.discussWidgets = {
    attach(context, settings) {

      if ($('.main-page--arrow span', context).length) {
        ...
        $(window).scroll(function () {
          var element = document.querySelector('.main-page--news');
          if (Visible(element)) {
            $('.main-page--arrow span').hide();
          } else {
            $('.main-page--arrow span').show();
          }
        });
